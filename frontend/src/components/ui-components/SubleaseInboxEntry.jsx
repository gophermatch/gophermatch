...
export default function SubleaseInboxEntry ({sublease_id, deleteSub}) {
    ...
    return (
        <div className="flex flex-col h-[11vh] w-full" key={sublease_id}>
                            <div className="flex">
                                <div className="flex flex-row w-full">
                                    ...
                                    <div className="flex flex-col w-full text-start justify-start">
                                        <div className="flex flex-row">
                                            <button className="text-[2.5vh] mt-[1.5vh] ml-[1vw] font-roboto font-[390] text-maroon" onClick={() => displayProfile(person)}>{subleaseData.building_name}</button>
                                        </div>
                                        <div className="flex flex-row">
                                            <button className="ml-[1vw] text-[2vh] font-[200] text-black" onClick={() => displayProfile(person)}>{``}</button>
                                        </div>
                                    </div>
