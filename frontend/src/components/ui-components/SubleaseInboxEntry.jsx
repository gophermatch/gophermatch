                                ...
                                <div className="flex" key={0}>
                                    <div className="flex flex-row w-full">
                                        <div className="flex flex-col w-full text-start justify-start">
                                            <p className="text-[2.5vh] mt-[1.5vh] ml-[1vw] w-[30vw] font-roboto font-[390] text-maroon">{`Address - Single`}</p>
                                            <div className="flex flex-row">
                                                <p className="ml-[1vw] text-xs text-left text-[1.5vh] w-[25vw] font-roboto font-light">email here</p>
                                            </div>
                                        </div>
