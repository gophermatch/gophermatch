      ...
      <div className="bg-doc min-h-screen flex items-start px-4 ">
        <header className="text-maroon mt-[30vh] text-[12.5vh] font-lora">
          ...
          <Link to="/landing/go-to-signup" className="text-maroon flex items-center">
            <span className="text-[3vh] text-maroon ml-[5vw] mt-[2vh] hover:text-gold">Get started</span>
            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-maroon mt-5 ml-2">
