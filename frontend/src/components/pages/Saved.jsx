...
export default function Saved() {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            <div className="h-[5vh] w-[40vw] bg-maroon rounded-tr-[1vh] rounded-tl-[1vh] text-white text-[2.5vh] text-center font-light font-roboto">
                    ...
                    <div className="flex flex-row w-full">
                            ...
                            <div className=" flex flex-col w-full text-start justify-start">
                                ...
                                <svg version="1.1"
                                    ...
                                    style={{marginLeft: '0.5vw', marginTop: '1.5vh'}}>
