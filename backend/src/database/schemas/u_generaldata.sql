CREATE TABLE u_generaldata (
    ...
    substances ENUM('Yes', 'No') DEFAULT NULL,
    alcohol ENUM('Yes', 'No') DEFAULT NULL,
    room_activity ENUM('Party', 'Friends', 'Empty') DEFAULT NULL,
    tidiness ENUM('no shoes', 'clean', 'leaves stuff on ground') DEFAULT NULL,
    num_residents INT DEFAULT -1,
    num_beds INT DEFAULT -1,
    num_bathrooms INT DEFAULT -1,
    move_in_month ENUM('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December') DEFAULT NULL,
    move_out_month ENUM('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December') DEFAULT NULL,
    ...
    housing_preference ENUM('apartments', 'dorms', 'both') DEFAULT NULL,
    college VARCHAR(32) DEFAULT "",  -- Replace with actual college names
    major VARCHAR(32) DEFAULT "",  -- Replace with actual major names
